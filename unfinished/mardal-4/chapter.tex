...
~\cite{ArnoldFalkWinther1997a,ArnoldFalkWinther2000,Hiptmair1997,Hiptmair1999}.   
...
aggregation step~\cite{GeeSiefertHuEtAl2006,HuTuminaroBochevEtAl2006}. 
...
Block preconditioners have been used in a varity of applications, we refer
to \citep{MardalWinther11}
and the references therein for a more complete discussion on this topic. 
For an overview of similar and alternative preconditioning techniques cf.
eg.~\citep{BenziGolubLiesen2005,ElmanSilvesterWathen2005}. 
