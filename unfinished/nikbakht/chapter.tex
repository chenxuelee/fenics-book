...
objects \emp{Poisson::FunctionSpace}, \emp{Poisson::BilinearForm}
and \emp{Poisson::LinearForm} is problem specific and has been
...
space in the code extract is intialized with \emp{surfaces}, which
is a container of \emp{GenericSurface} objects. This is a convenience
wrapper for a \ufc{} function space, with \emp{GenericPUM} being created
internally from the surfaces, and then used to initialize the
\ufc{} objects.  Note also the use of \emp{pum::Function}, which is a
subclass of \emp{dolfin::Function} and implements primarily restrictions
...
A mesh with superimposed discontinuity surfaces and
