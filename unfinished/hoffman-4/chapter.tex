...
\index{Parallel adaptive mesh refinement}
...
A common edge bisection algorithm bisects all edges in an element,
...
Independent of which metric one tries to solve. The result from the
...
The refinement algorithm outlined in \ref{hoffman-4:sect:modlong} is easily
...
stack \cite{GaraBlumrichChenEtAl2005, MoreiraAlmA¡siEtAl2005}.
...
\begin{figure}[bt]
  \begin{center}
    \includegraphics[width=0.45\columnwidth]{chapters/hoffman-4/pdf/cylmesh.pdf}
    \includegraphics[width=0.45\columnwidth]{chapters/hoffman-4/pdf/hillmesh2.pdf}
  \end{center}
