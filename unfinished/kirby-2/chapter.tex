...
framework described in Chapter~\ref{} as a Python package, working
mainly in terms of numerical linear algebra.  Although an
implementation floating-point arithmetic presents some challenges
relative to symbolic computation, it can allow greater efficiency and
consume fewer resources, especially for high order elements.  To
...
This chapter works in the context of a Ciarlet triple \( (K,P,N) \)~\cite{Ciarlet1978},
...
\( P^\prime \).  Recalling Chapter~\cite{missing}, the goal is first to
