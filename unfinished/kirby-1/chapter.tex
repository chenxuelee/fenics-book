...
Recently, Kirby~\cite{Kirby2009,Kirby2010} has analyzed finite element operators based on Bernstein
...
that is, the  degree of freedom in different elements is shared if they correspond to the same global point in the mesh. 
