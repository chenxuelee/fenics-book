...
reference domains. This framework is used by both the FIAT and SyFi projects.  
...
\]
The Bernstein polynomials on the tetrahedron and even higher dimensional simplices are completely
analogous.
...
Rules based on barycentric symmetry~\citep{missing} may be used up to a
