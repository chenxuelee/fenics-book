...
\caption{Two different CSF flow pulses. The blue line is a sine pulse,
    whereas the green represent the pressure pulse in a heart chamber.}
\label{fig:sin_pulse}.
\end{center}\end{figure}
...
\caption{The case with and translated elliptic cord. The pictures show the velocity in z-direction for the non-symmetric pulse at the time steps $t=0.07s, 0.18s, 0.25s$.}
\label{fig:case3b}.
\end{center}\end{figure}
