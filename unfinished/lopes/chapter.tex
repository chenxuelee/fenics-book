\fenicschapter{Improved Boussinesq Equations for Surface
  ...
  Water Waves} {Nuno D. Lopes, P. J. S. Pereira and
  L. Trabucho} {lopes}
...
like FUNWAVE  (see~\cite{Kirby2004}), COULWAVE
...
unknows in this two horizontal dimensional model with
$n$-layers increases from $3$ to $2n+1$. Thus, the
computational time is also increased, accordingly.


The global Boussinesq solver by~\cite{PedersenLovholt2008}
...
for shoreline runup/rundow, numerical filters or effects
...
As mentioned in~\cite{LovholtPedersen2009}, instabilities
...
As in~\cite{LovholtPedersen2009}, we find
...
From Fig.~\ref{fig:lopes:zhaonwogu}, we can compare the
...
FUNWAVE manual (see~\cite{Kirby2004}).  Even though we do
