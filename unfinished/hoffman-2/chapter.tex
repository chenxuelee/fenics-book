...
equation. However, since we typically choose to move the mesh with the
continuum velocity in the case of a solid phase, one can think of
this as an ALE method.
...
in \cite{HoffmanJanssonLoggEtAl2009}. The resulting discrete UC equations are:
\begin{equation}
...
{
public:
  /// Constructor: give boundary conditions, coefficients
  UCSolver(Function& U, Function& U0, Function** bisect,
           Mesh& mesh, Array <BoundaryCondition*>& bc_mom,
  ...
  /// Allocate/deallocate PDE data for dynamic mesh adaptivity
