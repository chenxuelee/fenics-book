...
has analyzed\vadjust{\pagebreak} finite element operators based on Bernstein polynomials.
...
Raviart--Thomas element.  In contrast to the previous\vadjust{\pagebreak} elements, this
