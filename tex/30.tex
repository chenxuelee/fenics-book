...
element for modeling \hbox{discontinuities} and formulate it in such a way that
...
\begin{figure}
  \centering
  \fenicsfig{nikbakht}{domain}{\largefig}
...
assembler (and additional helper functions), we develop extensions of
...
\subfloat[]{\includegraphics[height=\twofigs]{chapters/nikbakht/png/mesh.png}
  ...
  \subref{fig:nikbakht:poisson_contours_a} mesh and discontinuity surfaces
  and \subref{fig:nikbakht:poisson_contours_b} solution contours.}
