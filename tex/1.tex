...
that is applied to solve the linear system arising from the variational
...
is 50 or larger, so we may insert a code segment that
...
\end{python}
Here, \emp{u\_exact} will be interpolated onto the function
