...
\begin{figure}
  \ffigbox{\caption[The dyadic cleft]{(A): A diagram showing the
...
\begin{figure}
\ffigbox{\caption[Discrete markov models]{(A): State diagram of the
    ...
    $\beta$ and $\delta$ propensities are constant.}\label{fig:hake:markov-models}}
...
\vspace*{-3pt}\subsection{Finding an optimal stabilization parameter}
