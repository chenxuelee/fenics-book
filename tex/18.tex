...
\frac{\partial \sigma^s_{ij}}{\partial t} &= 2\mu_s \epsilon(u)_{ij} + \frac{\partial u_i}{\partial x_k} \thinspace \sigma^s_{kj} + \sigma^s_{ik} \frac{\partial u_k}{\partial x_i} \quad &\text{(incompressible Neo-Hookean solid)}
\end{align}
...
either \emp{http://www.csc.kth.se/ctl}
