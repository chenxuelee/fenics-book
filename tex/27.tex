...
the previous one, except\AQ{Figure~27.12 figure \& citation not in ms} that since it is a dynamic calculation, it also
...
\begin{figure}
\bwfig
  \ffigbox{\caption{Relaxation and subsequent re-twisting of a
...
than just fixing\AQ{27.17~figure \& citation  not in ms} a traction force on the surface of the dolphin to
