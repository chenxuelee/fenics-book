...
distributed CBC.Pdesys package.
...
def conv(u_tilde, u_bar, v, mode="standard"):
    if (mode == "Standard"):
        return inner(u_tilde*nabla_grad(u_bar), v)
    elif (mode == "Divergence"):
        return inner(nabla_div(outer(u_tilde, u_bar)), v)
    elif (mode == "Skew"):
        return 0.5*(inner(u_tilde*nabla_grad(u_bar), v) + \
        inner(nabla_div(outer(u_tilde, u_bar)), v))
\end{python}
