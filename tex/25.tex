...
$\phi(x,y,z,t)$\index{potential} to obtain Bernoulli's equation:\vspace*{-4pt}
\begin{equation}
\label{eq:lopes:bern}
...
\bwfig
  \centering
  \includegraphics[width=\twofigs]{chapters/lopes/png/L0_5_spike_stability.png}
  \includegraphics[width=\twofigs]{chapters/lopes/png/L0_5_shelf_stability.png}
  \caption{Unstable wave modes of the ZTC (red circles) and standard
    potential (blue points) models for the spike (left panel) and shelf
...
the color scale presented in Figure~\ref{fig:lopes:scale}.\pagebreak
