...
\item The elements of $\mathcal{L}$ are usually referred to as the
  ...
  in\break Figure~\ref{kirby-6:fig:notation}.
...
\label{kirby-6:tab:overview}\vspace*{7pt}
\end{table}

\begin{figure}[!t]
\bwfig
\includegraphics{0001335336/272415_1_en_3_fig1_print.eps}
...
\begin{figure}[!b]
\includegraphics{0001335336/272415_1_en_3_fig2_print.eps}
...
ratio of the simplex, and $u$ is a sufficiently regular function (or~vector-field).
...
\index{finite element!Crouzeix--Raviart}

\begin{figure}[!t]
\includegraphics{0001335336/272415_1_en_3_fig3_print.tif}
\caption{The Lagrange $\mathrm{CG}_{q}$ triangle for $q = 1,2,3,4,5,6$.}
\label{kirby-6:fig:lagrange:2d}\vspace*{8pt}%}
\end{figure}


\begin{figure}[!t]
\includegraphics{0001335336/272415_1_en_3_fig4_print.tif}
\caption{The Lagrange $\mathrm{CG}_{q}$ tetrahedron for $q = 1,2,3,4,5,6$.}
...
Stokes equations. The global element space consists of piecewise linear polynomials, as for the linear Lagrange element. However, in contrast to
...
\begin{figure}[!t]
\AQ{Please provide text citation for Figs.\,3.5--3.17.}
\centering
\includegraphics{0001335336/272415_1_en_3_fig5_print.tif}
\caption{Illustration of the Crouzeix--Raviart elements on
triangles and tetrahedra. The degrees of freedom are point
evaluation at the midpoint of each facet.}\label{kirby-6:fig:cr:tri}
\end{figure}
...
\index{finite element!Raviart--Thomas}
...
\begin{definition}[Raviart--Thomas element]
  ...
  defined for $q = 1, 2, \dots$ by\vspace*{-2.5pt}\enlargethispage*{12pt}
  \begin{align}
    T &\in \{ \mathrm{triangle}{}, \mathrm{tetrahedron}{}\}, \\
...
\begin{figure}
\centering
\includegraphics{0001335336/272415_1_en_3_fig6_print.tif}
...
three-dimensional space and consists of vector fields of the form\vspace*{-2.5pt}
\begin{equation}
v(x) = \alpha + \beta x,\vspace*{-2.5pt}
\end{equation}
...
\begin{figure}[t!]
\centering
\includegraphics{0001335336/272415_1_en_3_fig7_print.tif}
...
\label{kirby-6:fig:bdm}\vspace*{6pt}
\end{figure}


%------------------------------------------------------------------------------
\subsection{The Brezzi--Douglas--Marini element}
\index{finite element!Brezzi--Douglas--Marini}
...
\index{finite element!Mardal--Tai--Winther}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335336/272415_1_en_3_fig8_print.tif}
...
illustrated by point evaluation of normal components.}\vspace*{2pt}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics{0001335336/272415_1_en_3_fig9_print.tif}
...
The dimension of $\mathrm{MTW}$ is\vspace*{6pt}
\begin{equation}
n=9.
\end{equation}
...
\noindent Letting $\Pi_T$ denote the interpolation operator defined by the
...
\index{finite element!Arnold--Winther}
...
\begin{definition}[Arnold--Winther element]
  ...
  defined by\enlargethispage{8pt}
  \begin{align}
    T &= \mathrm{triangle}{},  \\
  ...
  \end{align}
\end{definition}
The dimension of $\mathrm{AW}$ is\vspace*{3pt}
\begin{equation}
  n = 24.
\end{equation}
...
\index{finite element!N\'ed\'elec}
...
\begin{definition}[\nedelec{} $\Hcurl$ element of the first kind]
  ...
  defined for $q = 1, 2, \dots$ in two dimensions by\enlargethispage{6pt}
  \begin{align}
    T &= \mathrm{triangle}{}, \\
    ...
    \right.
  \end{align}
where $t$ is the edge tangent; and in three dimensions by\vspace*{-3pt}
  \begin{align}
  ...
  \end{align}
\end{definition}
The dimension of $\mathrm{NED}^1_q$ is\vspace*{-3pt}
\begin{equation}
  n(q) = \left \{
  \begin{array}{ll}
  q (q + 2), & T \text{ triangle}, \\
...
\begin{figure}
\centering
\includegraphics{0001335336/272415_1_en_3_fig10_print.tif}
...
elements''.}\label{kirby-6:fig:ned1}\vspace*{-6pt}
\end{figure}

Letting $\Pi_T^q$ denote the interpolation operator defined by the
degrees of freedom above, we have that \citep[Theorem 2]{Nedelec1980}\vspace*{-3pt}\enlargethispage{12pt}
\begin{equation}
...
defined for $q = 1, 2, \dots$ in two dimensions by\vspace*{-3pt}
\begin{align}
    T &= \mathrm{triangle}, \\
...
\begin{figure}
\centering
\includegraphics{0001335336/272415_1_en_3_fig11_print.tif}
\caption{Illustration of first, second and third degree \nedelec{}
$\Hcurl$ elements of the second kind on triangles. Note that
these elements may be viewed as \emph{rotated}
Brezzi--Douglas--Marini elements.}\label{kirby-6:fig:ned2:tri}\vspace*{5pt}
\end{figure}

\begin{figure}
\centering
\includegraphics{0001335336/272415_1_en_3_fig12_print.tif}
\caption{Illustration of the first degree \nedelec{} $\Hcurl$
elements of the second kind on tetrahedra.}\label{kirby-6:fig:ned2:tet}
\end{figure}
...
methods imposing  the desired \hbox{continuity} weakly instead of
...
\index{finite element!Discontinuous Lagrange}
...
%\vspace*{-1pc}
  \centering
\includegraphics{0001335336/272415_1_en_3_fig13_print.tif}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335336/272415_1_en_3_fig14_print.eps}
\caption{All degrees of freedom of a discontinuous Lagrange finite
    ...
    here for discontinuous quadratic Lagrange elements.}\vspace*{8pt}
\end{figure}


\subsection{The Argyris element}
\index{finite element!Argyris}
...
The\enlargethispage{12pt} (quintic) Argyris element ($\mathrm{ARG}_5$) is defined by\vspace*{-4pt}
\begin{align}
    T &= \mathrm{triangle}, \\
  ...
  \end{align}
\end{definition}
The dimension of $\mathrm{ARG}_5$ is\vspace*{3pt}
\begin{equation}
  n = 21.
\end{equation}
Letting $\Pi_T$ denote the interpolation operator defined by the
...
\begin{equation}
  ...
  ||u - \Pi_T u||_{L^2(T)} \leqslant C \, h_T^{6} |u|_{H^6(T)}.\vspace*{4pt}
\end{equation}

\begin{figure}[!t]
\centering
\includegraphics{0001335336/272415_1_en_3_fig15_print.tif}
\caption{The quintic Argyris triangle. The degrees of freedom are
    ...
    midpoint of each edge.}\label{kirby-6:fig:argyris}
\end{figure}
...
\begin{definition}[Hermite element]
  ...
  \end{align}
\end{definition}
The dimension of $\mathrm{HER}$ is\vspace*{7pt}
\begin{equation}
n = \left \{
\begin{array}{ll}
...
\begin{figure}
  \centering
\includegraphics{0001335336/272415_1_en_3_fig16_print.tif}
...
\begin{figure}
  \centering
  \includegraphics{0001335336/272415_1_en_3_fig17_print.tif}
...
The bubble element\index{finite element!Bubble element} ($B_q$) is defined for $q \geqslant (d+1)$ by
\begin{align}
    T &\in \{ \mathrm{interval}{}, \mathrm{triangle}{}, \mathrm{tetrahedron}{}\}, \\
...
\index{finite element exterior calculus}
...
\newcolumntype{T}{>{\centering\arraybackslash}m{1.4cm}}
   ...
   \begin{longtable}{p{4.1cm}SSTp{4cm}}
     ...
     \hline
     (Quintic) Argyris             & $\mathrm{ARG}_5$   (2D) & \includegraphics{0001335336/272415_1_en_3_figa_print.tif}   & $n = 21$ &
     \elmdesc{$\Poly{5}$ (scalar); $3$ point \nobreak values, $3 \times 2$ derivatives, $3\times 3$ second derivatives, $3$ directional derivatives}
     \hline
     Arnold--Winther               & $\mathrm{AW}$      (2D) & \includegraphics{0001335336/272415_1_en_3_figb_print.tif}     & $n = 24$ &
     \elmdesc{$\Poly{3}(T; \mathbb{S})$ (matrix) with linear divergence; $3 \times 3$ point values, $12$ normal components, $3$ interior moments}
     \hline
     Brezzi--Douglas--Marini $(*)$ & $\mathrm{BDM}_1$   (2D) & \includegraphics{0001335336/272415_1_en_3_figc_print.tif}   & $n = 6$ &
     \elmdesc{$[\Poly{1}]^2$ (vector); $6$ normal components}
     \hline
     Brezzi--Douglas--Marini $(*)$ & $\mathrm{BDM}_2$   (2D) & \includegraphics{0001335336/272415_1_en_3_figd_print.tif}   & $n = 12$ &
     \elmdesc{$[\Poly{2}]^2$ (vector); $9$ normal components, $3$ interior moments}
     \hline
     Brezzi--Douglas--Marini $(*)$ & $\mathrm{BDM}_3$   (2D) & \includegraphics{0001335336/272415_1_en_3_fige_print.tif}   & $n = 20$ &
     \elmdesc{$[\Poly{3}]^2$ (vector); $12$ normal components, $8$ interior moments}
     \hline
     Brezzi--Douglas--Marini $(*)$ & $\mathrm{BDM}_1$   (3D) & \includegraphics{0001335336/272415_1_en_3_figf_print.tif}   & $n = 12$ &
     \elmdesc{$[\Poly{1}]^3$ (vector); $12$ normal components}
     \hline
     Brezzi--Douglas--Marini $(*)$   & $\mathrm{BDM}_2$   (3D) & \includegraphics{0001335336/272415_1_en_3_figg_print.tif}   & $n = 30$ &
     \elmdesc{$[\Poly{2}]^3$ (vector); $24$ normal components, $6$ interior moments}
     \hline
     Brezzi--Douglas--Marini $(*)$   & $\mathrm{BDM}_3$   (3D) & \includegraphics{0001335336/272415_1_en_3_figh_print.tif}   & $n = 60$ &
     \elmdesc{$[\Poly{3}]^3$ (vector); $40$ normal components, $20$ interior moments}
     \hline
     Crouzeix--Raviart       $(*)$   & $\mathrm{CR}_1$    (2D) & \includegraphics{0001335336/272415_1_en_3_figi_print.tif}    & $n = 3$ &
     \elmdesc{$\Poly{1}$ (scalar); $3$ point values}
     \hline
     Crouzeix--Raviart       $(*)$   & $\mathrm{CR}_1$    (3D) & \includegraphics{0001335336/272415_1_en_3_figj_print.tif}    & $n = 4$ &
     \elmdesc{$\Poly{1}$ (scalar); $4$ point values}
     \hline
     Discontinuous Lagrange  $(*)$   & $\mathrm{DG}_0$    (2D) & \includegraphics{0001335336/272415_1_en_3_figk_print.tif}    & $n = 1$ &
     \elmdesc{$\Poly{0}$ (scalar); $1$ point value}
     \hline
     Discontinuous Lagrange  $(*)$   & $\mathrm{DG}_1$    (2D) & \includegraphics{0001335336/272415_1_en_3_figl_print.tif}    & $n = 3$ &
     \elmdesc{$\Poly{1}$ (scalar); $3$ point values}
     \hline
     Discontinuous Lagrange  $(*)$   & $\mathrm{DG}_2$    (2D) & \includegraphics{0001335336/272415_1_en_3_figm_print.tif}    & $n = 6$ &
     \elmdesc{$\Poly{2}$ (scalar); $6$ point values}
     \hline
     Discontinuous Lagrange  $(*)$   & $\mathrm{DG}_3$    (2D) & \includegraphics{0001335336/272415_1_en_3_fign_print.tif}    & $n = 10$ &
     \elmdesc{$\Poly{3}$ (scalar); $10$ point values}
     \hline
     Discontinuous Lagrange  $(*)$   & $\mathrm{DG}_0$    (3D) & \includegraphics{0001335336/272415_1_en_3_figo_print.tif}    & $n = 1$ &
     \elmdesc{$\Poly{0}$ (scalar); $1$ point value}
     \hline
     Discontinuous Lagrange  $(*)$   & $\mathrm{DG}_1$    (3D) & \includegraphics{0001335336/272415_1_en_3_figp_print.tif}    & $n = 4$ &
     \elmdesc{$\Poly{1}$ (scalar); $4$ point values}
     \hline
     Discontinuous Lagrange  $(*)$   & $\mathrm{DG}_2$    (3D) & \includegraphics{0001335336/272415_1_en_3_figq_print.tif}    & $n = 10$ &
     \elmdesc{$\Poly{2}$ (scalar); $10$ point values}
     \hline
     Discontinuous Lagrange  $(*)$   & $\mathrm{DG}_3$    (3D) & \includegraphics{0001335336/272415_1_en_3_figr_print.tif}    & $n = 20$ &
     \elmdesc{$\Poly{3}$ (scalar); $20$ point values}
     \hline
     (Cubic) Hermite              & $\mathrm{HER}$     (2D) & \includegraphics{0001335336/272415_1_en_3_figs_print.tif}    & $n = 10$ &
     \elmdesc{$\Poly{3}$ (scalar); $4$ point values, $3 \times 2$ derivatives}
     \hline
     (Cubic) Hermite              & $\mathrm{HER}$     (3D) & \includegraphics{0001335336/272415_1_en_3_figt_print.tif}    & $n = 20$ &
     \elmdesc{$\Poly{3}$ (scalar); $8$ point values, $4 \times 3$ derivatives}
     \hline
     Lagrange                $(*)$ & $\mathrm{CG}_1$    (2D) & \includegraphics{0001335336/272415_1_en_3_figu_print.tif}    & $n = 3$ &
     \elmdesc{$\Poly{1}$ (scalar); $3$ point values}
     \hline
     Lagrange                $(*)$ & $\mathrm{CG}_2$    (2D) & \includegraphics{0001335336/272415_1_en_3_figv_print.tif}    & $n = 6$ &
     \elmdesc{$\Poly{2}$ (scalar); $6$ point values}
     \hline
     Lagrange                $(*)$ & $\mathrm{CG}_3$    (2D) & \includegraphics{0001335336/272415_1_en_3_figw_print.tif}    & $n = 10$ &
     \elmdesc{$\Poly{3}$ (scalar); $10$ point values}
     \hline
     Lagrange                $(*)$ & $\mathrm{CG}_1$    (3D) & \includegraphics{0001335336/272415_1_en_3_figx_print.tif}   & $n = 4$ &
     \elmdesc{$\Poly{1}$ (scalar); $4$ point values}
     \hline
     Lagrange                $(*)$ & $\mathrm{CG}_2$    (3D) & \includegraphics{0001335336/272415_1_en_3_figy_print.tif}    & $n = 10$ &
     \elmdesc{$\Poly{2}$ (scalar); $10$ point values}
     \hline
     Lagrange                $(*)$ & $\mathrm{CG}_3$    (3D) & \includegraphics{0001335336/272415_1_en_3_figz_print.tif}   & $n = 20$ &
     \elmdesc{$\Poly{2}$ (scalar); $20$ point values}
     \hline
     Mardal--Tai--Winther         & $\mathrm{MTW}$     (2D) & \includegraphics{0001335336/272415_1_en_3_figaa_print.tif}    & $n = 9$ &
     ...
     \hline
     (Quadratic) Morley           & $\mathrm{MOR}$     (2D) & \includegraphics{0001335336/272415_1_en_3_figab_print.tif}    & $n = 6$ &
     \elmdesc{$\Poly{2}$ (scalar); $3$ point values, $3$ directional derivatives}
     \hline
     \nedelec{} 1st kind $\Hcurl$ $(*)$ & $\mathrm{NED}^1_1$ (2D) & \includegraphics{0001335336/272415_1_en_3_figac_print.tif} & $n = 3$ &
     \elmdesc{$[\Poly{0}]^2 + S_1$ (vector); $3$ tangential components}
     \hline
     \nedelec{} 1st kind $\Hcurl$ $(*)$ & $\mathrm{NED}^1_2$ (2D) & \includegraphics{0001335336/272415_1_en_3_figad_print.tif} & $n = 8$ &
     \elmdesc{$[\Poly{1}]^2 + S_2$ (vector); $6$ tangential components, $2$ interior moments}
     \hline
     \nedelec{} 1st kind $\Hcurl$ $(*)$ & $\mathrm{NED}^1_3$ (2D) & \includegraphics{0001335336/272415_1_en_3_figae_print.tif} & $n = 15$ &
     \elmdesc{$[\Poly{2}]^2 + S_3$ (vector); $9$ tangential components, $6$ interior moments}
     \hline
     \nedelec{} 1st kind $\Hcurl$ $(*)$ & $\mathrm{NED}^1_1$ (3D) & \includegraphics{0001335336/272415_1_en_3_figaf_print.tif} & $n = 6$ &
     \elmdesc{$[\Poly{0}]^3 + S_1$ (vector); $6$ tangential components}
     \hline
     \nedelec{} 1st kind $\Hcurl$ $(*)$ & $\mathrm{NED}^1_2$ (3D) & \includegraphics{0001335336/272415_1_en_3_figag_print.tif} & $n = 20$ &
     \elmdesc{$[\Poly{1}]^3 + S_2$ (vector); $20$ tangential components}
     \hline
     \nedelec{} 1st kind $\Hcurl$ $(*)$ & $\mathrm{NED}^1_3$ (3D) & \includegraphics{0001335336/272415_1_en_3_figah_print.tif} & $n = 45$ &
     \elmdesc{$[\Poly{2}]^3 + S_3$ (vector); $42$ tangential components, $3$ interior moments}
     \hline
     \nedelec{} 2nd kind $\Hcurl$ $(*)$ & $\mathrm{NED}^2_1$ (2D) & \includegraphics{0001335336/272415_1_en_3_figai_print.tif} & $n = 6$ &
     \elmdesc{$[\Poly{1}]^2$ (vector); $6$ tangential components}
     \hline
     \nedelec{} 2nd kind $\Hcurl$ $(*)$ & $\mathrm{NED}^2_2$ (2D) & \includegraphics{0001335336/272415_1_en_3_figaj_print.tif} & $n = 12$ &
     \elmdesc{$[\Poly{2}]^2$ (vector); $9$ tangential components, $3$ interior moments}
     \hline
     \nedelec{} 2nd kind $\Hcurl$ $(*)$ & $\mathrm{NED}^2_3$ (2D) & \includegraphics{0001335336/272415_1_en_3_figak_print.tif} & $n = 20$ &
     \elmdesc{$[\Poly{3}]^2$ (vector); $12$ tangential components, $8$ interior moments}
     \hline
     \nedelec{} 2nd kind $\Hcurl$ $(*)$ & $\mathrm{NED}^2_1$ (3D) & \includegraphics{0001335336/272415_1_en_3_figal_print.tif} & $n = 12$ &
     \elmdesc{$[\Poly{1}]^3$ (vector); $12$ tangential components}
     \hline
     Raviart--Thomas         $(*)$ & $\mathrm{RT}_1$    (2D) & \includegraphics{0001335336/272415_1_en_3_figam_print.tif}    & $n = 3$ &
     \elmdesc{$[\Poly{0}]^2 + x \Poly{0}$ (vector); $3$ normal components}
     \hline
     Raviart--Thomas         $(*)$ & $\mathrm{RT}_2$    (2D) & \includegraphics{0001335336/272415_1_en_3_figan_print.tif}    & $n = 8$ &
     \elmdesc{$[\Poly{1}]^2 + x \Poly{1}$ (vector); $6$ normal components, $2$ interior moments}
     \hline
     Raviart--Thomas         $(*)$ & $\mathrm{RT}_3$    (2D) & \includegraphics{0001335336/272415_1_en_3_figao_print.tif}    & $n = 15$ &
     \elmdesc{$[\Poly{2}]^2 + x \Poly{2}$ (vector); $9$ normal components, $6$ interior moments}
     \hline
     Raviart--Thomas         $(*)$ & $\mathrm{RT}_1$    (3D) & \includegraphics{0001335336/272415_1_en_3_figap_print.tif}   & $n = 4$ &
     \elmdesc{$[\Poly{0}]^3 + x \Poly{0}$ (vector); $4$ normal components}
     \hline
     Raviart--Thomas         $(*)$ & $\mathrm{RT}_2$    (3D) & \includegraphics{0001335336/272415_1_en_3_figaq_print.tif}   & $n = 15$ &
     \elmdesc{$[\Poly{1}]^3 + x \Poly{1}$ (vector); $12$ normal components, $3$ interior moments}
     \hline
     Raviart--Thomas         $(*)$ & $\mathrm{RT}_3$    (3D) & \includegraphics{0001335336/272415_1_en_3_figar_print.tif}   & $n = 36$ &
...
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figa_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figb_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figc_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figd_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_fige_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figf_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figg_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figh_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figi_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figj_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figk_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figl_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figm_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_fign_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figo_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figp_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figq_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figr_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figs_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figt_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figu_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figv_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figw_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figx_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figy_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figz_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figaa_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figab_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figac_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figad_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figae_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figaf_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figag_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figah_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figai_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figaj_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figak_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figal_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figam_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figan_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figao_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figap_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figaq_print.tif}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335336/272415_1_en_3_figar_print.tif}
%%%%\caption{}
%%%%\end{figure}
