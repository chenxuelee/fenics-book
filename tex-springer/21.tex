...
% FIXME: Small fonts in figures should be fixed when rerunning with DOLFIN 1.0
...
%%%    \end{python}
\includegraphics{0001335354/272415_1_en_21_fig1_print.eps}
...
\label{sec:ipcs}
\index{incremental pressure correction}
...
%%%    \end{python}
\includegraphics{0001335354/272415_1_en_21_fig2_print.eps}
...
\label{sec:css}
\index{consistent splitting scheme}
...
%%%    \end{python}
\includegraphics{0001335354/272415_1_en_21_fig3_print.eps}
...
In each time step, the simplified G2 solution is defined by
\begin{equation}
  \begin{split}
    \renni{v}{D_t^n u_h}
...
%%%Lw = inner(u1, z)*dx
%%%\end{python}
\includegraphics{0001335354/272415_1_en_21_fig4_print.eps}
...
%%%    \end{python}
\includegraphics{0001335354/272415_1_en_21_fig5_print.eps}
...
%%%            values[1] = 0.0
%%%  \end{python}
\includegraphics{0001335354/272415_1_en_21_fig6_print.eps}
...
%%%solve(a == L, psi, bc)
%%%    \end{python}
\includegraphics{0001335354/272415_1_en_21_fig7_print.eps}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335354/272415_1_en_21_fig8_print.eps}
...
\centering
  %\ffigbox{
\includegraphics{0001335354/272415_1_en_21_fig9_print.eps}
...
%%%        y[1] = x[1] - 2.0
%%%    \end{python}
\includegraphics{0001335354/272415_1_en_21_fig10_print.eps}
...
\centering
  %\ffigbox{
\includegraphics{0001335354/272415_1_en_21_fig11_print.tif}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335354/272415_1_en_21_fig12_print.eps}
...
\begin{figure}[!t]
  \centering
  %\ffigbox{
 \includegraphics{0001335354/272415_1_en_21_fig13_print.eps}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335354/272415_1_en_21_fig14_print.eps}
...
%%\bwfig
\centering
\includegraphics{0001335354/272415_1_en_21_fig15_print.tif}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335354/272415_1_en_21_fig16_print.eps}
...
%%%\bwfig
\centering
\includegraphics{0001335354/272415_1_en_21_fig17_print.tif}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335354/272415_1_en_21_fig18_print.eps}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335354/272415_1_en_21_fig19_print.eps}
...
The version of G2 described in Section~\ref{sec:g2} is modeled after
...
\begin{figure}[!t]
\centering
\includegraphics{0001335354/272415_1_en_21_fig20_print.eps}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335354/272415_1_en_21_fig21_print.eps}
