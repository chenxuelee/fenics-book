...
%%%L = inner(f, v)*dx
%%%\end{python}
\includegraphics{0001335353/272415_1_en_20_fig1_print.eps}
...
\includegraphics{0001335353/272415_1_en_20_fig2_print.eps}
  \caption{A Taylor--Hood element with
%  \subref{fig:terrel:THElements_P3}
(a)
  cubic velocity basis and
%  \subref{fig:terrel:THElements_P2}
  (b) quadratic
...
\bwfig
  ...
  \includegraphics{0001335353/272415_1_en_20_fig3_print.eps}
...
\narrowfigure
%  \centering
\includegraphics{0001335353/272415_1_en_20_fig4_print.eps}
...
%%%V = P + B
%%%\end{python}
\includegraphics{0001335353/272415_1_en_20_fig5_print.eps}
...
%%%\end{python}
\includegraphics{0001335353/272415_1_en_20_fig6_print.eps}
...
%%    iters += 1
%%\end{python}
\includegraphics{0001335353/272415_1_en_20_fig7_print.eps}
...
%%  }
\includegraphics{0001335353/272415_1_en_20_fig8_print.eps}
...
%%%
%%%\end{python}
\includegraphics{0001335353/272415_1_en_20_fig9_print.eps}
...
%%%f = Constant((0.0, 0.0))
%%%\end{python}
\includegraphics{0001335353/272415_1_en_20_fig10_print.eps}
...
%%%\end{python}
\includegraphics{0001335353/272415_1_en_20_fig11_print.eps}
...
\begin{figure}[!t]
  %\centering
  \includegraphics{0001335353/272415_1_en_20_fig12_print.eps}
...
\begin{figure}[!t]
 % \centering
  \includegraphics{0001335353/272415_1_en_20_fig13_print.eps}
...
\begin{figure}[!p]
  %\centering
  \includegraphics[scale=.96]{0001335353/272415_1_en_20_fig14_print.eps}
...
\begin{figure}[!p]
 % \centering
  \includegraphics[scale=.96]{0001335353/272415_1_en_20_fig15_print.eps}
...
\begin{figure}[!p]
%\centering
\includegraphics[scale=.96]{0001335353/272415_1_en_20_fig16_print.eps}
...
\begin{figure}[!t]
\centering
\includegraphics{0001335353/272415_1_en_20_fig17_print.eps}
...
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335353/272415_1_en_20_fig14_print.eps}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335353/272415_1_en_20_fig15_print.eps}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335353/272415_1_en_20_fig16_print.eps}
%%%%\caption{}
%%%%\end{figure}
%%%%\begin{figure}
%%%%\includegraphics{0001335353/272415_1_en_20_fig17_print.eps}
