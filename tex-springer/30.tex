...
with discontinuities in the \nobreak solution across evolving surfaces. The
partition-of-unity/extended finite element approach is\break adopted, and
...
\begin{figure}[!b]
\centering
\includegraphics{0001335363/272415_1_en_30_fig1_print.eps}
\caption{Domain $\Omega$ intersected by a discontinuity
surface~$\Gamma_{d}$.}\label{fig:nikbakht:domain}\vspace*{-6pt}
\end{figure}
%
...
Consider a decomposition of the function $u$ according to%\enlargethispage{12pt}
%
\begin{equation}
...
an ``enriched'' space:\vspace*{1.5pt}
%
\begin{python}
...
\noindent  In the above, \emp{Ec} is a regular scalar Lagrange finite element
...
\noindent We can also restrict coefficients, test and trial functions
...
\citet{JagerSteinmannKuhl2008}, for example), and the \emp{GenericSurface}
...
%%%%L = f*v*dx
%%%%\end{python}
\includegraphics{0001335363/272415_1_en_30_fig2_print.eps}
...
%%%}
%%%\end{c++}
\includegraphics{0001335363/272415_1_en_30_fig3_print.eps}
...
code for conventional problems.}\label{fig:nikbakht:poisson_c++}\vspace*{5pt}
\end{figure}
%
...
solution contours for this problem on a unit square domain containing two disjoint discontinuity surfaces are shown in\break Figure~\ref{fig:nikbakht:poisson_contours}.  For this case, $f = 1$ and $k = 1$.  Homogeneous Dirichlet boundary conditions are applied
...
\begin{figure}[!t]
%\bwfig
%%%\subfloat[]{\includegraphics[height=\twofigs]{chapters/nikbakht/png/mesh.png}
%%%    \label{fig:nikbakht:poisson_contours_a}}
%%%  \subfloat[]{\includegraphics[height=\twofigs]{chapters/nikbakht/png/result.png}
%%%    \label{fig:nikbakht:poisson_contours_b}}
\includegraphics{0001335363/272415_1_en_30_fig4_print.tif}
\caption{Poisson problem in two dimensions:
(a) mesh and discontinuity surfaces
and (b) solution contours.}\label{fig:nikbakht:poisson_contours}\vspace*{12pt}
\end{figure}
...
%%%L = f*w*dx
%%%\end{python}
\includegraphics{0001335363/272415_1_en_30_fig5_print.eps}
\caption{Form compiler input for the mixed Poisson problem with
discontinuous~$u$ and~$\vect{\sigma}$.}
\label{code:nikbakht:mixed-Poisson}\vspace*{5pt}
\end{figure}
...
%%%L = inner(f, v)*dx
%%%\end{python}
\includegraphics{0001335363/272415_1_en_30_fig6_print.eps}
...
the solution across $\Gamma_{d}$, the relevant function space reads\vspace*{4pt}
%
\begin{equation}
...
\noindent For homogeneous Dirichlet boundary conditions and traction-free
...
\end{multline}
%
and the linear form reads:\vspace*{8pt}
%
\begin{equation}
L(\vect{v}_{h})=\int_{\Omega} \vect{f} \cdot \vect{v}_{h} \dif x,\vspace*{1.5pt}
\end{equation}
%
where
$\vect{\sigma}(\vect{u})
...
%%%a = derivative(L, u, du)
%%%\end{python}
\includegraphics{0001335363/272415_1_en_30_fig7_print.eps}
...
%%%file << u;
%%%\end{c++}
\includegraphics{0001335363/272415_1_en_30_fig8_print.eps}
