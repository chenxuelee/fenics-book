...
\begin{figure}[!b]
\centering
\includegraphics{0001335360/272415_1_en_27_fig1_print.eps}
...
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig2_print.eps}
...
%%%    return S
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig3_print.eps}
...
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig4_print.eps}
...
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig5_print.eps}
...
%%%solver.solve()
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig6_print.eps}
...
%%%    a = derivative(L, U, dU)
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig7_print.eps}
...
%\bwfig
  \centering
  \includegraphics{0001335360/272415_1_en_27_fig8_print.tif}
...
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig9_print.eps}
...
%%u = twist.solve()
%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig10_print.eps}
...
%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig11_print.eps}
...
\begin{figure} %[!t]
%\bwfig
\includegraphics{0001335360/272415_1_en_27_fig12_print.eps}
  %\ffigbox{
...
\begin{figure}[!t]
  ...
  \includegraphics{0001335360/272415_1_en_27_fig13_print.eps}
...
When \emp{Release} is\enlargethispage{12pt} instantiated and its \emp{solve} method is
...
%%%        return material
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig14_print.eps}
...
%%%    t = t + dt
%%%\end{python}
\includegraphics{0001335360/272415_1_en_27_fig15_print.eps}
...
\begin{figure}[!t]
%\bwfig
\includegraphics{0001335360/272415_1_en_27_fig16_print.eps}
  %\ffigbox{
...
%%%\end{figure}
%%%\begin{figure}[!t]
%%%\includegraphics{0001335360/272415_1_en_27_fig18_print.eps}
%%%\caption{}
%%%\end{figure}
