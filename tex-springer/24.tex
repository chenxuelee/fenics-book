...
%\bwfig
\centering
\includegraphics{0001335357/272415_1_en_24_fig1_print.tif}
...
narrow foramen magnum and the cyst.}\label{fig:anatomy}\vspace*{5pt}
\end{figure}
...
tissue and bone~\citep{MilhoratBolognese2003}. \pagebreak Control images
...
To simulate CSF flow, we apply the Navier--Stokes  equations for an incompressible
Newtonian fluid,
\begin{equation}
\begin{split}
...
\begin{tabular}{ccccc}\toprule
    Symbol & Meaning & Unit & Value Used & Reference \\\midrule
...
\noindent To define the domain correctly, we override the base class
...
\noindent The vectors describing the ellipses of the cord and the dura in a
...
%\bwfig
  ...
  \includegraphics{0001335357/272415_1_en_24_fig2_print.tif}
...
\noindent The following parameters have been used with this function.
\begin{python}
A = 2.9/16
...
%\bwfig
  ...
  \includegraphics{0001335357/272415_1_en_24_fig3_print.tif}
  \caption{The figure shows the user-interface of Gmsh during the making
    of a mesh.}\label{fig:Gmsh_mesh}
\end{figure}
...
\begin{figure}[!t]
\includegraphics{0001335357/272415_1_en_24_fig4_print.tif}
\caption{The case with a circular cord and the boundary
      ...
      will be used in all subsequent figures.}\label{fig:case1}\vspace*{12pt}
\end{figure}
...
\centering
\begin{tabular}{ccccc}\toprule
Pressure (Pa)\ Solver & Chorin & IPCS & G2 \\\midrule
...
\caption{Pressure differences between various places in the spinal canal.
    ...
    p$ in the cross sections $0.1\,\mathrm{cm}$, $0.5\,\mathrm{cm}$, $1.0\,\mathrm{cm}$, and $2.0\,\mathrm{cm}$ down from the top.}\label{solvers:pressurediff}\vspace*{4pt}
\end{table}
...
\begin{figure}
%\bwfig
  \includegraphics{0001335357/272415_1_en_24_fig5_print.tif}
  %\ffigbox{
  \caption{The case with circular cord and the boundary
...
\noindent transforms the cross section of the inner cylinder to an elliptic
...
\noindent  Also for this case the pressure field was identical, with some
variations in the flow profiles, see Figure~\ref{fig:case3b}.

\begin{figure}[!t]
\centering
\includegraphics{0001335357/272415_1_en_24_fig6_print.tif}
\caption{The case with an elliptic cord and the boundary
...
the time steps $t=0.07s, 0.18s, 0.25s$.}\label{fig:case3}\vspace*{10pt}
\end{figure}

\begin{figure}[!t]
\centering
\includegraphics{0001335357/272415_1_en_24_fig7_print.tif}
\caption{The case with a translated elliptic cord. The
...
\begin{figure}[!t]
\centering
\includegraphics{0001335357/272415_1_en_24_fig8_print.tif}
\caption{The case with an enlarged cord diameter and the
boundary conditions based on the pressure pulse. The pictures
show the velocity in z-direction for the non-symmetric pulse at
the time steps $t=0.07s, 0.18s, 0.25s$.}\label{fig:case4}\vspace*{8pt}
\end{figure}
