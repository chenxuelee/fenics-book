...
Goda~\cite{Goda1979}. The IPCS scheme is summarized in Scheme~2 and
...
see references~\cite{T-99,M-W-04,M-W-09,C-C-88}. In fact
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=50mm]{chapters/kvs-1/pdf/periodic_v.pdf}
      \includegraphics[width=50mm]{chapters/kvs-1/pdf/periodic_p.pdf}
    }
...
\begin{figure}
  \begin{center}
    \fbox{\includegraphics[width=14cm]{chapters/kvs-1/pdf/cylinderandgeoattime5nr2.pdf}}
...
We next consider a problem described in~\cite{EthierSteinmann1994} where an
...
{chapters/kvs-1/pdf/aneurysm_at_end_css1.pdf}}
