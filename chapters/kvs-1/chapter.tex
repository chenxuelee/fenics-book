...
scheme (G2) by \citet{JohnsonHoffman2007}, and a saddle-point solver
...
to \citet{JohnsonHoffman2007}. In each time step, the G2 solution is
defined by
\begin{equation}
  \begin{split}
    \renni{v}{D_t^n u_h}
...
\citep{Turek1999,MardalWinther2004,MardalWinther,CahouetChabard1988}. In
...
saccular aneu\-rysm (see Chapter~\ref{chap:kvs-2}). The diameter of
