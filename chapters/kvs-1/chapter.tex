...
\begin{figure}
  \ffigbox{\caption{Results for the driven cavity test problem.}
...
\begin{figure}
  \ffigbox{\caption{Results for the pressure-driven channel test problem.}
           \label{fig:channel_results}}
          {\includegraphics[width=\textwidth]{chapters/kvs-1/pdf/new_channel_res.pdf}}
\end{figure}
...
\begin{figure}
  \ffigbox{\caption{Results for the Taylor--Green vortex test problem.}
    \label{fig:periodic_res}}
  {\includegraphics[width=\textwidth]{chapters/kvs-1/pdf/new_periodic_res.pdf}}
\end{figure}
...
\begin{figure}
  ...
  {\includegraphics[width=\textwidth]{chapters/kvs-1/pdf/cylinderandgeoattime5nr2.pdf}}
\end{figure}
...
\begin{figure}
  ...
  {\includegraphics[width=\textwidth]{chapters/kvs-1/pdf/new_cylinder_res.pdf}}
\end{figure}
...
\begin{figure}
  ...
  {\includegraphics[width=\textwidth]{chapters/kvs-1/pdf/new_beltrami_res.pdf}}
\end{figure}
...
\begin{figure}
  ...
  {\includegraphics[width=\textwidth]{chapters/kvs-1/pdf/new_aneurysm_res.pdf}}
\end{figure}
...
\begin{figure}
  \ffigbox{
    ...
    \label{fig:scatter}}
  {\includegraphics[width=\textwidth]{chapters/kvs-1/pdf/new_scatter.pdf}}
\end{figure}
