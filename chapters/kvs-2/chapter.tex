...
by the reduced risk of SAH with increased number of
...
\editornote{Fig `Idealized model of a bifurcation' has not label, therefore
...
larger diameters in the vasculatory system, errors in 
the overall velocities have been shown to
be of order 3-10\% in large arteries such as the pulmonary arteries;
