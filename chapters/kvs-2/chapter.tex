...
\begin{figure}
  \center\includegraphics[width=\largefig]{chapters/kvs-2/png/cow_gray_1.png} \\
...
\begin{figure}
  \center\includegraphics[width=\largefig]{chapters/kvs-2/pdf/kentus.pdf}
...
\begin{figure}
  \ffigbox{
    ...
    \label{fig:kvs-2:imagseg}}
          {
            \includegraphics[width=0.4\textwidth]{chapters/kvs-2/pdf/stacks.pdf}
            \includegraphics[width=0.4\textwidth]{chapters/kvs-2/pdf/3d.pdf}
            \includegraphics[width=0.6\textwidth]{chapters/kvs-2/pdf/viper3.pdf}
          }
\end{figure}
...
\begin{figure}
  \ffigbox{\caption{Patient-specific Circle of Willis (of the second author).}
          ...
          {\includegraphics[width=\textwidth]{chapters/kvs-2/pdf/cok_top_steam_white.pdf}}
\end{figure}
