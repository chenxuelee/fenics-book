...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=80mm]{chapters/kvs-2/pdf/peiro_cow.pdf}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=80mm]{chapters/kvs-2/pdf/CerebralAneurysms.pdf}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=80mm]{chapters/kvs-2/pdf/kentus.pdf}
    }
  \end{center}
...
et al.~\cite{FordAlperinLeeEtAl2005}, where the average velocity was measured for
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=80mm]{chapters/kvs-2/pdf/systolic.pdf}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=100mm]{chapters/kvs-2/pdf/zero_dp_vs_res.pdf}
    }
  \end{center}
...
\begin{figure} \label{fig:imagseg}
  \begin{center}
    \fbox{
      \includegraphics[width=4.5cm]{chapters/kvs-2/pdf/stacks.pdf}
      \includegraphics[width=4.5cm]{chapters/kvs-2/pdf/3d.pdf}
      \includegraphics[width=4.5cm]{chapters/kvs-2/pdf/viper3.pdf}
    }
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=60mm]{chapters/kvs-2/pdf/bifurcation_clean.pdf}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=10cm]{chapters/kvs-2/pdf/mcas_wss_II4.pdf}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=10cm]{chapters/kvs-2/pdf/icas_wss.pdf}
}
...
In this study, see also~\cite{JiangJohnsonValen-SendstadEtAl2010}, we quantitatively compared CFD,
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=152mm]{chapters/kvs-2/pdf/mass_dog.pdf}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=152mm]{chapters/kvs-2/pdf/dog_data_mr_cfd.pdf}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=60mm]{chapters/kvs-2/pdf/ica.pdf}
      \includegraphics[width=80mm]{chapters/kvs-2/pdf/cok_inflow.pdf}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=152mm]{chapters/kvs-2/pdf/cok_top_steam_white.pdf}
    }
  \end{center}
...
\begin{figure}
  \begin{center}
    \fbox{
      \includegraphics[width=7.51cm]{chapters/kvs-2/pdf/cok_slice.pdf}
      \includegraphics[width=7.51cm]{chapters/kvs-2/pdf/cok_ica_vel_peak_syst.pdf}
    }
