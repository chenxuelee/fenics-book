...
by~\cite{LindekleivValen-SendstadMorganEtAl2010} concerning gender
differences in cerebral arteries, a study of the carotid arteries of a
canine with an induced aneurysm described
in~\cite{JiangJohnsonValen-SendstadEtAl2010}, and a study of the blood
...
world~\cite{Feigin2005}, and mortality rates could increase
dramatically in the years to come~\cite{MurrayLopez1997}. Stroke is
...
by the rupture of one or more aneurysms~\cite{Humphrey2001}. Aneurysms
...
lifetime~\cite{Weir2002}. Unfortunately, aneurysms also rupture at a
relatively early age. The average age of rupture is 52
years~\cite{Humphrey2001}. An intracranial aneurysm is a dilatation of
...
turnover~\cite{DAVIESREMUZZIGORDONEtAl1986}, that aneurysms may grow
in the direction of low wall shear
stress~\cite{BousselRayzMcCullochEtAl2008}, and that flow pattern and
impingement zones affect the possibility of
rupture~\cite{CebralCastroBurgessEtAl2005}. The vessel wall clearly
...
vasculature~\cite{Humphrey2001,Stehbens1975}.  Furthermore, the
...
completely~\cite{Fung1984}. Gender, ethnicity, and lifestyle have
shown to be of
importance~\cite{MhurchuAndersonJamrozikEtAl2001,LongstrethNelsonKoepsellEtAl1994,KongableLanzinoGermansonEtAl1996}.
...
from~\cite{FordAlperinLeeEtAl2005}, where the average velocity was
...
from~\cite{AlastrueyParkerPeiroEtAl2007} and show a clear relation
...
Toolkit (VMTK)~\cite{vmtk}, where a 3D surface model is generated
...
by~\cite{LindekleivValen-SendstadMorganEtAl2010} where it is shown
...
(SAH)~\cite{EdenMeurerSanchezEtAl2008}. The reason is not
...
see~\cite{IngebrigtsenMorganFaulderEtAl2004}, we therefore wished to
...
and MCA from~\cite{KrejzaSzydlikLiebeskindEtAl2005} were used as
inflow boundary conditions in the simulations. Table~\ref{bcs}
summarizes the input values to the simulations,
cf.~\cite{LindekleivValen-SendstadMorganEtAl2010}.  At the outflows,
...
see~\cite{LindekleivValen-SendstadMorganEtAl2010}.
...
In another study, see~\cite{JiangJohnsonValen-SendstadEtAl2010}, we
...
see~\cite{LotzMeierLeppertEtAl2002,EvansIwaiGristEtAl1993}.
...
according to~\cite{GermanBlack1965}. The inlet diameter was
...
refer to~\cite{JiangJohnsonValen-SendstadEtAl2010}. To get higher
...
the
literature~\cite{AlastrueyParkerPeiroEtAl2007,Vignon-ClementelFigueroaJansenEtAl2006}.
