...
\cite{ZhaoTengCheng2004} to investigate the behaviour of surface water waves.
...
and {\bf C}heng (ZTC)  \cite{ZhaoTengCheng2004} (see subsection \ref{lopes:subsec:ztc}).
\end{itemize}
...
function  to generate surface water waves, as  proposed in \cite{WeiKirbySinha1999}.
...
al. \cite{WangWuChengEtAl2008} as well as  Dash and Daripa  \cite{DashDaripa2002},
...
write \(\phi_1\)   in terms of \(\phi_0\) (cf. \cite{ChenLiu1994}, \cite{ZhaoTengCheng2004}).
...
is used with two main consequences  (cf. \cite{ZhaoTengCheng2004}):
\begin{itemize}
...
al.  \cite{WeiKirbySinha1999}, a source function\index{source function}
...
generation band (cf. \cite{WeiKirbySinha1999}).
%}}}
...
in \cite{Engsig-KarupHesthavenBinghamEtAl2006}.
