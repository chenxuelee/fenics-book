...
simulation of surface water waves (see \emp{http://ptmat.fc.ul.pt/$\sim$ndl/}).
...
In Section~\ref{sec:lopes:linearanalysis},
...
The global Boussinesq solver by~\citet{PedersenLovholt2008}
...
tree: \emp{dolfwave/src/1hd1sforms}, \emp{dolfwave/src/1hdforms}
and \emp{dolfwave/src/2hdforms}).  These files are compiled using \ffc
...
at \emp{https://launchpad.net/dolfwave}. Some tools for the generation
...
(see \emp{http://www.cmap.polytechnique.fr/$\sim$jouve/xd3d/}).
DOLFWAVE has a large number of demos covering all the implemented
models (see \emp{dolfwave/demo}). Different physical effects are
...
\begin{figure}
\begin{center}
\fenicsfig{lopes}{graph_tex}{\largefig}
\end{center}
...
RungeKutta classes (see \emp{dolfwave/src/predictorcorrector}
and \emp{dolfwave/src/rungekutta}).
...
at \emp{dolfwave/demo/2HD/srcFunction}.
%}}}
...
As mentioned in~\citet{LovholtPedersen2009}, instabilities
...
As in~\citet{LovholtPedersen2009}, we find
...
\begin{figure}
 \begin{center}
\includegraphics[width=\smallfig]{chapters/lopes/png/L_2_spike_stability.png}
\includegraphics[width=\smallfig]{chapters/lopes/png/L_2_shelf_stability.png}
 \end{center}
 \caption{Unstable wave modes of the ZTC (red circles) and
 standard potential (blue points)
 models for the spike (left panel) and
 shelf (right panel) geometries with $l=2$\,~{\tt m}.}
 \label{fig:lopes:spectrum1}
 \end{figure}

\begin{figure}
 \begin{center}
\includegraphics[width=\smallfig]{chapters/lopes/png/L_1_spike_stability.png}
\includegraphics[width=\smallfig]{chapters/lopes/png/L_1_shelf_stability.png}
 \end{center}
 \caption{Unstable wave modes of the ZTC (red circles) and
 standard potential (blue points) models for the spike (left panel) and
 shelf (right panel) geometries with $l=1$\,~{\tt m}.}
 \label{fig:lopes:spectrum2}
 \end{figure}

\begin{figure}
 \begin{center}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_0.5_spike_stability}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_0.5_shelf_stability}
 \end{center}
 \caption{Unstable wave modes of the ZTC (red circles) and
 standard potential (blue points) models for the spike (left panel) and
 shelf (right panel) geometries with $l=0.5$\,~{\tt m}.}
 \label{fig:lopes:spectrum3}
 \end{figure}

\begin{figure}
 \begin{center}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_2_dx_0.02_hm_spike_spectrum_StdPot}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_2_dx_0.02_hm_shelf_spectrum_StdPot}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_2_dx_0.02_hm_spike_spectrum_Zhao}
...
\begin{figure}
 \begin{center}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_1_dx_0.1_hm_spike_spectrum_StdPot}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_1_dx_0.1_hm_shelf_spectrum_StdPot}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_1_dx_0.1_hm_spike_spectrum_Zhao}
...
\begin{figure}
 \begin{center}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_0.5_dx_0.25_hm_spike_spectrum_StdPot}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_0.5_dx_0.25_hm_shelf_spectrum_StdPot}
\includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L_0.5_dx_0.25_hm_spike_spectrum_Zhao}
...
\emp{dolfwave/tools/Nwogu}).  Specifically, a finite element
...
We start now  the description of the problem along with the DOLFWAVE code used to
...
In the numerical simulation of a solitary wave passing
...
section~\ref{sec:lopes:numericalmethods}.  The DOLFWAVE demo code for
this example is available at \emp{dolfwave/demo/2HD/harbor}.
...
\begin{figure}
\begin{center}
\fenicsfig{lopes}{scale_tex}{6.0cm}
\end{center}
\caption{Color scale.}
...
Note that we also use here the color scale presented in Figure~\ref{fig:lopes:scale}.
\begin{figure}
\begin{center}
...
here with those provided by other models is achieved
(see \emp{dolfwave/demo/2HD/hLandslide}).  These other models include
...
than Nwogu's model.
  ...
  In the second test, the evolution of a Gaussian hump in a
...
is achieved (see \emp{dolfwave/demo}).  From these numerical
...
simulations, can be found at \emp{http://ptmat.fc.ul.pt/$\sim$ndl} and
\emp{https://launchpad.net/dolfwave}.
