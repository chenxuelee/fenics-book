...
\begin{figure}
  \begin{center}
    \includegraphics[width=\smallfig]{chapters/lopes/png/L2_spike_stability.png}
    \includegraphics[width=\smallfig]{chapters/lopes/png/L2_shelf_stability.png}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\smallfig]{chapters/lopes/png/L1_spike_stability.png}
    \includegraphics[width=\smallfig]{chapters/lopes/png/L1_shelf_stability.png}
  \end{center}
  \caption{Unstable wave modes of the ZTC (red circles) and standard
    potential (blue points) models for the spike (left panel) and shelf
...
\begin{figure}
  \begin{center}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L0.5_spike_stability}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L0.5_shelf_stability}
  \end{center}
  \caption{Unstable wave modes of the ZTC (red circles) and standard
    potential (blue points) models for the spike (left panel) and shelf
...
\begin{figure}
  \begin{center}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L2_dx_0.02_hm_spike_spectrum_StdPot}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L2_dx_0.02_hm_shelf_spectrum_StdPot}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L2_dx_0.02_hm_spike_spectrum_Zhao}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L2_dx_0.02_hm_shelf_spectrum_Zhao}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L1_dx_0.1_hm_spike_spectrum_StdPot}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L1_dx_0.1_hm_shelf_spectrum_StdPot}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L1_dx_0.1_hm_spike_spectrum_Zhao}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L1_dx_0.1_hm_shelf_spectrum_Zhao}
  \end{center}
  \caption{Eigenvalue spectrum for the standard potential (upper
    panels) and ZTC (lower panels) models for the spike (left panels) and
...
\begin{figure}
  \begin{center}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L0.5_dx_0.25_hm_spike_spectrum_StdPot}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L0.5_dx_0.25_hm_shelf_spectrum_StdPot}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L0.5_dx_0.25_hm_spike_spectrum_Zhao}
    \includegraphics[type=png,ext=.png,read=.png,width=\smallfig]{chapters/lopes/png/L0.5_dx_0.25_hm_shelf_spectrum_Zhao}
  \end{center}
  \caption{Eigenvalue spectrum for the standard potential (upper
    panels) and ZTC (lower panels) models for the spike (left panels) and
