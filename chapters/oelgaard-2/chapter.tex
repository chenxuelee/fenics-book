...
\editornote{Explain what \emp{FE0} etc. mean in Figure~\ref{oelgaard-2:fig:O_simplify_code}!}
...
\editornote{Very hard to read legends and axes in Figure~\label{oelgaard-2:fig:laplace_stats_2}, please fix!}
...
\emp{-O2 -funroll-loops}, in which case the runtime has improved by a
...
\editornote{Mismatch between Figure~\ref{fig:oelgaard-2:fig:hyper_stats_2} and text which claims that \emp{-basis -zeros} is the best option.}
