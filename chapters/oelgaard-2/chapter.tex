...
\item[Loop invariant code motion] In short, this procedure seeks to
  ...
  this technique, which is also known as `loop hoisting' \index{loop
    hoisting}, can be found in~\citet{AhoSethiUllman1986}.
...
The results were obtained by using the optimization options \emp{-f
eliminate\_zeros -f simplify\_expressions} for the quadrature
representation.  In
