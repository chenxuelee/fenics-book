...
$\composition$ remains in its initial boundaries; that is, $0 \leqslant
\composition \leqslant 1$, and to minimize dispersion error.  We refer the
...
\begin{algorithm}
  ...
  (4) Assign to $\composition_i \leqslant | \composition_{\min} |$ value 0. \\
  (5) Assign to $\composition_i \geqslant 2 - \composition_{\max} $ value 1. \\
