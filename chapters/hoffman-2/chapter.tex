...
aerodynamics. See figure \ref{fig:flag3D} for a plot of a model problem
...
\editornote{Above figures should not be bitmaps}
...
the compressible
\emp{CNSSolver}. See figure \ref{fig:compr3D} for an example plot of compressible flow around a
