...
\begin{figure}
  \centering
  \subfigure[$P_3$ for $V$]{\includegraphics[scale=.3]{chapters/terrel/eps/P3.eps}}
  \hspace{2em}
  \subfigure[$P_2$ for $\Pi$]{\includegraphics[scale=.3]{chapters/terrel/eps/P2.eps}}
...
\begin{figure}
  \centering
  \subfigure[Crouzeix-Raviart for $V$]{\includegraphics[scale=.3]{chapters/terrel/eps/CR.eps}}
  \hspace{2em}
  \subfigure[$P_0$ for $\Pi$]{\includegraphics[scale=.3]{chapters/terrel/eps/P0.eps}}
...
\includegraphics[scale=.25]{chapters/terrel/eps/mesh.eps}
\label{terrel:fig:mesh}
}
\qquad
\subfigure[Velocity magnitude of test problem]{
\includegraphics[scale=.25]{chapters/terrel/eps/vel_test.eps}
\label{terrel:fig:vel_test}
}
\qquad
\subfigure[Velocity magnitude of lid driven cavity with streamlines]{
\includegraphics[scale=.25]{chapters/terrel/eps/vel_lid.eps}
...
\ufl{} v0.4.0, \ufc{} v1.2.0) with \projectfont{UMFPACK}'s LU solver (from the
\projectfont{SuiteSparse} package v3.4).  Because we are using direct linear
...
\begin{figure}
  \centering
  \subfigure[]{
    \includegraphics[scale=.65]{chapters/terrel/eps/vel_4.eps}
    \label{terrel:fig:4th_Order:vel}
  }
  \subfigure[]{
    \includegraphics[scale=.65]{chapters/terrel/eps/press_4.eps}
...
\begin{figure}
  \subfigure[]{
    \includegraphics[scale=.65]{chapters/terrel/eps/div_4.eps}
    \label{terrel:fig:4th_Order_2:div}
  }
  \subfigure[]{
    \includegraphics[scale=.65]{chapters/terrel/eps/run_4.eps}
