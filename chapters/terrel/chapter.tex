...
\begin{figure}
  \center
  \subfloat[$P_3$ for $V$]{\includegraphics[width=\twofigs]{chapters/kirby-6/pdf/P3.pdf}
    \label{fig:terrel:THElements_P3}}
  \hspace{2em}
  \subfloat[$P_2$ for $\Pi$]{\includegraphics[width=\twofigs]{chapters/kirby-6/pdf/P2.pdf}
...
\begin{figure}
  ...
  \includegraphics[width=\largefig]{chapters/terrel/pdf/vel_test.pdf}
  \label{fig:terrel:vel_test}
  }
  \qquad
  \subfloat[Velocity magnitude and streamlines for the lid-driven cavity test problem.]{
  \includegraphics[width=\largefig]{chapters/terrel/pdf/vel_lid.pdf}
