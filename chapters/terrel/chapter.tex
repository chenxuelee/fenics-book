...
\begin{figure}
  \centering
  \subfigure[$P_3$ for $V$]{\includegraphics[scale=.3]{chapters/terrel/pdf/P3.pdf}}
  \hspace{2em}
  \subfigure[$P_2$ for $\Pi$]{\includegraphics[scale=.3]{chapters/terrel/pdf/P2.pdf}}
...
\begin{figure}
  \centering
  \subfigure[Crouzeix-Raviart for $V$]{\includegraphics[scale=.3]{chapters/terrel/pdf/CR.pdf}}
  \hspace{2em}
  \subfigure[$P_0$ for $\Pi$]{\includegraphics[scale=.3]{chapters/terrel/pdf/P0.pdf}}
