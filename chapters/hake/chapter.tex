...
\newcommand{\NaC}{\ensuremath{\left[\mbox{Na}^{+}\right]}\xspace}
\newcommand{\K}{\ensuremath{\mbox{K}^{+}}\xspace}
\newcommand{\HC}{\ensuremath{\left[\mbox{H}^{+}\right]}\xspace}
\renewcommand{\H}{\ensuremath{\mbox{H}^{+}}\xspace}
\newcommand{\KC}{\ensuremath{\left[\mbox{K}^{+}\right]}\xspace}
\newcommand{\Cl}{\ensuremath{\mbox{Cl}^{-}}\xspace}
\newcommand{\ClC}{\ensuremath{\left[\mbox{Cl}^{-}\right]}\xspace}
...
% positional numbers
\newcommand{\ith}{\ensuremath{i^{\scriptscriptstyle\text{th}}}\xspace}
\newcommand{\kth}{\ensuremath{k^{\scriptscriptstyle\text{th}}}\xspace}
\newcommand{\lth}{\ensuremath{l^{\scriptscriptstyle\text{th}}}\xspace}
\newcommand{\nth}{\ensuremath{n^{\scriptscriptstyle\text{th}}}\xspace}
\newcommand{\mth}{\ensuremath{m^{\scriptscriptstyle\text{th}}}\xspace}
...
\begin{figure}[t]
    \begin{minipage}[t]{\leftfigsize}
      \raisebox{-3.45cm}{\includegraphics[width=\linewidth]{chapters/hake/eps/error_plot}}
    \end{minipage}
    \hfill
...
\begin{figure}[b]
    \begin{minipage}[t]{\leftfigsize}
      \raisebox{-3.7cm}{\includegraphics[width=\linewidth]{chapters/hake/eps/traces_mesh_1}}
    \end{minipage}
    \hfill
    \begin{minipage}{\rightfigsize}
