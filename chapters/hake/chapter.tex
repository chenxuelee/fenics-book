...
Figure~\ref{fig:hake:morphology} \textbf{A}, a sketch of a small part of
...
$\Omega$ (see Figure~\ref{fig:hake:morphology} \textbf{B}).
...
Figure~\ref{fig:hake:morphology} \textbf{B}). To each boundary we assign
...
Figure~\ref{fig:hake:morphology} \textbf{B} a no-flux boundary, giving
us,
\begin{equation}
...
Figure~\ref{fig:hake:morphology} \textbf{B}). \Ca entering via these
