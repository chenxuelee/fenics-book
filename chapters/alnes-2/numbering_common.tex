...
\begin{figure}[htbp]
  \begin{center}
    ...
    %\psfrag{2}{$2$}
    %\psfrag{3}{$3$}
    \includegraphics[width=8cm]{chapters/alnes-2/pdf/numbering_example_triangles.pdf}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    %\psfrag{4}{$4$}
    %\psfrag{5}{$5$}
    \includegraphics[width=8cm]{chapters/alnes-2/pdf/numbering_example_quadrilaterals.pdf}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    %\psfrag{v2}{$v_2$}
    %\psfrag{e0}{$e_0$}
    \includegraphics[width=5cm]{chapters/alnes-2/pdf/ordering_example_triangle.pdf}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    %\psfrag{v3}{$v_3$}
    %\psfrag{e0}{$e_0$}
    \includegraphics[width=5cm]{chapters/alnes-2/pdf/ordering_example_tetrahedron.pdf}
    \caption{Mesh entities are ordered based on a lexicographical ordering
      of the corresponding ordered tuples of non-incident vertices.
...
\begin{figure}[htbp]
  \begin{center}
    ...
    %\psfrag{v2}{$v_2$}
    %\psfrag{v3}{$v_3$}
    \includegraphics[width=9cm]{chapters/alnes-2/pdf/orientation_example_triangles.pdf}
...
\paragraph{Numbering schemes for reference cells}
