...
\subsubsection{Numbering of vertices}
\index{vertex numbering}

For simplicial cells (intervals, triangles, and tetrahedra) of a
finite element mesh, the vertices are numbered locally based on the
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{2}{$2$}
    \psfrag{3}{$3$}
    \includegraphics[width=8cm]{chapters/alnes-2/eps/numbering_example_triangles.eps}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{4}{$4$}
    \psfrag{5}{$5$}
    \includegraphics[width=8cm]{chapters/alnes-2/eps/numbering_example_quadrilaterals.eps}
    \caption{The local numbering of vertices of a non-simplicial mesh
      is arbitrary, as long as each cell is topologically isomorphic to the
...
\subsubsection{Numbering of other mesh entities}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{v2}{$v_2$}
    \psfrag{e0}{$e_0$}
    \includegraphics[width=5cm]{chapters/alnes-2/eps/ordering_example_triangle.eps}
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{v3}{$v_3$}
    \psfrag{e0}{$e_0$}
    \includegraphics[width=5cm]{chapters/alnes-2/eps/ordering_example_tetrahedron.eps}
    \caption{Mesh entities are ordered based on a lexicographical ordering
      of the corresponding ordered tuples of non-incident vertices.
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \psfrag{v2}{$v_2$}
    \psfrag{v3}{$v_3$}
    \includegraphics[width=9cm]{chapters/alnes-2/eps/orientation_example_triangles.eps}
...
\subsubsection{Numbering schemes for reference cells}

The numbering scheme is demonstrated below for cells
isomorphic to each of the five reference cells.

\subsubsection{Numbering of mesh entities on intervals}
...
\subsubsection{Numbering of mesh entities on triangular cells}
%
\begin{minipage}{\textwidth}
\linespread{1.2}\selectfont
  \begin{center}
...
\subsubsection{Numbering of mesh entities on quadrilateral cells}
%
\begin{minipage}{\textwidth}
...
\subsubsection{Numbering of mesh entities on tetrahedral cells}
%
\begin{minipage}{\textwidth}
\linespread{1.1}\selectfont
  \begin{center}
...
\subsubsection{Numbering of mesh entities on hexahedral cells}
