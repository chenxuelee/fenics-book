...
settings. In \cite{GuptaSoellingerBoesigerEtAl2009,RoldanHaughtonWiebenEtAl2008} the
...
Gmsh is handy since it is easy to control how the geometry is meshed. The following code example shows the construction of a circular cylinder (representing the pia on the spinal cord) within an elliptic cylinder (representing the dura). 
