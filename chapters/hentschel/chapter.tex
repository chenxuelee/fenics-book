...
\editornote{Please add a short introduction here.}
\editornote{The subsubsection level has been replaced by paragraph. Check that this does not cause any problems for already existing use of paragraph in this chapter.}
...
\paragraph{Comparing different solvers.}
