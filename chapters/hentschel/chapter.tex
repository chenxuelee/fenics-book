...
the surrounds spinal cord. Particular attention is given to abnormal flow and pressure resulting from 
...
chapter to describe the implementation of such CFD solver in
\fenics\ and investigate the flow characteristics. Specifically, we investigate
different boundary conditions, different geometries, and also how far velocity and pressure disturbances travel
under realistic conditions. We also compare the different solvers Chorin, ICPS, and G2, c.f. Chapter~[kvs-1].
...
G2 solver has also produced some peculiar results in Chapter~[kvs-1]. We also remark that
