...
This chapters concerns the flow of cerebrospinal fluid (CSF) 
in the subarachnoid space surrounding the brain and spinal cord 
and the flows association with syringomyelia and the Chiari I malformation. 
...
CSF is a clear water-like fluid which
...
pressure. For calculating the correct physical pressure, static
...
\section{Conlusion}
In this chapter we have studied CSF flow in various idealized geometries representing the
spinal cord and the surrounding subarachnoid space using NetGen and GMSH. We have further 
