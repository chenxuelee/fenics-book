...
\ref{chap:wells}, \ref{chap:lopes}, \ref{chap:kvs-2}, and
\ref{chap:hentschel}.
...
\begin{figure}
  \begin{center}
    \fenicsfig{kirby-7}{heat_equation_model_domain}{\largefig}
...
\editornote{Insert index items for LBB conditions in other relevant chapters (by Kent and Marie).}
...
\editornote{Check use of ``affine'' in this chapter. The Piola mapping also
  maps the \emp{cell} affinely (or may use another mapping like isoparametric.)}
...
\begin{figure}
  \begin{center}
    \fenicsfig{kirby-7}{affinemap}{14cm}
...
\begin{figure}
  \begin{center}
    \fenicsfig{kirby-7}{femprojection}{\largefig}
