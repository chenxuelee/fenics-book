...
equations as shown in \citep{AlnaesMardal2009b}. Furthermore, the code
...
variant of Fung~\citep{Fung1993}, described by the following equations:
\begin{eqnarray}
\mathbf{F} &=& \mathbf{I} + (\nabla \mathbf{u}), \\
...
Jacobian.  This variational form is implemented in PyDolfin as follows:
\begin{python}
  mesh = UnitSquare(N, N)
