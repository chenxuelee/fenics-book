\fenicschapter{SyFi: Symbolic Finite Elements and SFC: SyFi Form Compiler}
              {SyFi and SFC}
              {Martin Sandve Aln\ae{}s and Kent-Andre Mardal}
              {alnes-3}

\editornote{AL: Suggested new title \emp{SyFi and SFC: Symbolic finite elements and form compilation}}
