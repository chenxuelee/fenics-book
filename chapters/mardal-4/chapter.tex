...
using \emp{cbc.block}\index{cbc.block} and the Python interfaces of DOLFIN and Trilinos\index{Trilinos}.
...
overview of \emp{cbc.block}. We then
...
The module also implements block partitioned matrices and vectors. These are pure python objects, and do not use the block matrix in \dolfin.
