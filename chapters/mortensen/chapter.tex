...
\item The sparse coefficient matrix can be compressed by removing
  ...
  the degrees of freedom of the finite element fields. The removal of
  nonzeros speeds up Krylov solvers, by making the matrix--vector
  product faster to compute, as well as preconditioners.
