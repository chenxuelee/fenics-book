...
\cite{nsbench} for laminar flows. In this chapter focus is put more
...
the benchmark chapter \cite{nsbench}, and are thus not repeated here.
...
\begin{figure}
 \centering
 \subfigure[Explicit convection, Eq.~(\ref{eq:EX}), CFL=0.1]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0_1_model_1.pdf}}
 \subfigure[Implicit convection, Eq.~(\ref{eq:IM2}), CFL=0.1]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0_1_model_0.pdf}}
 \subfigure[Explicit convection, Eq.~(\ref{eq:EX}), CFL=0.05]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0_05_model_1.pdf}}
 \subfigure[Implicit convection, Eq.~(\ref{eq:IM2}), CFL=0.05]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0_05_model_0.pdf}}
