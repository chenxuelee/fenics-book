...
\begin{figure}
 \centering
 \subfigure[Explicit convection, Eq. (\ref{eq:EX}), CFL=0.1]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/OS_energy_cfl_0.1_model_1.eps}}
 \subfigure[Implicit convection, Eq. (\ref{eq:IM2}), CFL=0.1]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/OS_energy_cfl_0.1_model_0.eps}}
 \subfigure[Explicit convection, Eq. (\ref{eq:EX}), CFL=0.05]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/OS_energy_cfl_0.05_model_1.eps}}
 \subfigure[Implicit convection, Eq. (\ref{eq:IM2}), CFL=0.05]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/OS_energy_cfl_0.05_model_0.eps}}
