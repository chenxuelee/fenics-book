...
\begin{figure}
 \centering
 \subfloat[Explicit convection, Eq.~(\ref{eq:EX})]{
 \includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_init_cfl_1.pdf}
}
\subfloat[Implicit convection, Eq.~(\ref{eq:IM2})]{
...
\begin{figure}
 \centering
 \subfloat[Explicit convection, Eq.~(\ref{eq:EX}), CFL=0.1]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0_1_model_1.pdf}}
 \subfloat[Implicit convection, Eq.~(\ref{eq:IM2}), CFL=0.1]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0_1_model_0.pdf}}
 \subfloat[Explicit convection, Eq.~(\ref{eq:EX}), CFL=0.05]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0_05_model_1.pdf}}
 \subfloat[Implicit convection, Eq.~(\ref{eq:IM2}), CFL=0.05]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0_05_model_0.pdf}}
