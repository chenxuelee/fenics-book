...
The three alternative versions of the convective term discussed in Sec. \ref{sec:Convection} have be implemented in the method {\fontsize{12pt}{12pt}\texttt{conv}} as
...
%     L0 = rhs(F)
% ecod
% Here u0 and u1 represent known velocity fields at timesteps $n-1$ and $n$ respectively and p0 is the latest available pressure. The pressure correction (\ref{eq:PC}) is implemented as
% bcod
...
The variational form of Burger's equation transferred to FEniCS is obtained by multiplying (\ref{eq:burgers}) with test function $v$ and integrating over the domain, using the Dirichlet boundary conditions. The resulting variational form is
\begin{equation}
...
Note that the coefficient matrix {\fontsize{12pt}{12pt}\texttt{A}} needs to be reassembled due to the
...
\begin{figure}
 \centering
 \subfigure[Explicit convection, Eq.~(\ref{eq:EX}), CFL=0.1]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0.1_model_1.pdf}}
 \subfigure[Implicit convection, Eq.~(\ref{eq:IM2}), CFL=0.1]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0.1_model_0.pdf}}
 \subfigure[Explicit convection, Eq.~(\ref{eq:EX}), CFL=0.05]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0.05_model_1.pdf}}
 \subfigure[Implicit convection, Eq.~(\ref{eq:IM2}), CFL=0.05]{\includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/OS_energy_cfl_0.05_model_0.pdf}}
...
\begin{figure}
  \centering
  \subfigure[]{
  \includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/TG_disserror_model_0_cfl_0.05_Re_100_dofs.pdf}
}
  \subfigure[]{
  \includegraphics[width=0.45\textwidth]{chapters/mortensen/pdf/TG_energyerror_model_0_cfl_0.05_Re_100_dofs.pdf}
}
