...
% kinetic energy (the energy of the velocity fluctuations) in
...
discretiztion we will here follow 
...
% For the current initialization and $\kappa=0$, the Burger's equation
% allows a series analytical solution \citet{}
% \begin{equation}
...
The Orr--Sommerfeld equation (see \citet{Orzag1971}) is
...
\emp{OrrSommerfeld\_eig.py} that comes with the chapter. For the initialization
...
\begin{figure}
% \centering
% \subfigure[Explicit convection, \eqref{eq:mortensen:EX}]{
 \includegraphics[width=0.5\textwidth]{chapters/mortensen/pdf/OS_init_cfl_1.pdf}
%}
%\subfigure[Implicit convection, \eqref{eq:mortensen:IM2}]{
...
%}
  \caption{Relative errors in dissipation rate \eqref{eq:mortensen:diss} is
      shown in (a) and the energy \eqref{eq:mortensen:q} in (b). The
