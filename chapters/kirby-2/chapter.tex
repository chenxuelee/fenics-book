...
\begin{split}
\ell(v) & = \ell( \mathcal{R}(v)_{ij}\phi_j ) \\
...
\editornote{Something is wrong in \eqref{eq:strange}. Waiting for comment from Rob.}
...
\begin{figure}
  \center\includegraphics[width=4cm]{chapters/kirby-2/pdf/reftri.pdf}
...
\begin{figure}
  \center\includegraphics[width=4cm]{chapters/kirby-2/pdf/P3.pdf}
