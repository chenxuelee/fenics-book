...
In Unicorn, UC-FSI is implemented based on a continuous piecewise linear approximation in space and time, and a simple streamline diffusion stabilization is used, similar to the method in \citet{Hansbo2000}.
See \citet{HoffmanJanssonStockli2011} for details on the method.
