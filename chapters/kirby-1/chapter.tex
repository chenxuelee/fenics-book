...
\begin{figure}
  \begin{center}
    \includegraphics[height=3cm]{chapters/kirby-6/eps/P1.eps} \hspace{1.0cm}
    \includegraphics[height=3cm]{chapters/kirby-6/eps/P2.eps} \hspace{1.0cm}
    \includegraphics[height=3cm]{chapters/kirby-6/eps/P3.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[height=3cm]{chapters/kirby-6/eps/HER3.eps}
...
\begin{figure}
  \begin{center}
    \includegraphics[height=3.5cm]{chapters/kirby-6/eps/RT0.eps} \hspace{0.5cm}
    \includegraphics[height=3.5cm]{chapters/kirby-6/eps/RT1.eps} \hspace{0.5cm}
    \includegraphics[height=3.5cm]{chapters/kirby-6/eps/RT2.eps}
...
Mardal-Tai-Winther~\cite{MardalTaiEtAl02}, Tai-Winther~\cite{TaiWinther06}, and Bell~\cite{missing} element families.
