...
\newcommand{\elmfigsizesingle}{0.3\textwidth}
\newcommand{\elmfigsizedouble}{0.3\textwidth}
\newcommand{\elmfigsizetriple}{0.2\textwidth}
\newcommand{\elmfigsizequadruple}{0.15\textwidth}
...
\begin{figure}
  ...
  {\includegraphics[width=\textwidth]{chapters/kirby-6/pdf/P1_1d2d3d.pdf}}
\end{figure}

\begin{figure}
  \ffigbox{\caption{The Lagrange $\mathrm{CG}_{q}$ triangle for $q = 1,2,3,4,5,6$.}
           \label{kirby-6:fig:lagrange:2d}}
  {\includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG1_2d.png}
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG2_2d.png}
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG3_2d.png} \\
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG4_2d.png}
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG5_2d.png}
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG6_2d.png}}
\end{figure}

\begin{figure}
  \ffigbox{\caption{The Lagrange $\mathrm{CG}_{q}$ tetrahedron for $q = 1,2,3,4,5,6$.}
           \label{kirby-6:fig:lagrange:3d}}
  {\includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG1_3d.png}
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG2_3d.png}
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG3_3d.png} \\
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG4_3d.png}
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG5_3d.png}
   \includegraphics[width=0.27\textwidth]{chapters/kirby-6/png/CG6_3d.png}}
\end{figure}
