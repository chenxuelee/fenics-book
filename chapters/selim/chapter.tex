\fenicschapter{An adaptive finite element solver for fluid--structure interaction problems}
              {An adaptive finite element solver for FSI}
              {Kristoffer Selim}
              {selim}
...
\begin{figure}
  \centering
  \subfloat[]{\label{subfig:1:a}\includegraphics[width=\largefig]{chapters/selim/png/new_channel.png}} \\
  \subfloat[]{\label{subfig:1:b}\includegraphics[width=\largefig]{chapters/selim/png/channel_test_zoom.png}}
