...
framework \emp{CBC.Solve} developed at the Center for Biomedical
Computing at Simula Research Laboratory. Currently, \emp{CBC.Solve}
consists of two core components; \emp{CBC.Flow} and \emp{CBC.Twist}.
...
\caption{A code segment from the cG(1) version of the structure
  solver \emp{CBC.Twist}. In the cG(1) method, the structure problem
...
\begin{figure}[tbp!]
  \begin{center}
    \subfloat[]{\label{subfig:1:a}\includegraphics[scale=0.2]{chapters/selim/png/new_channel.png}} \\
    \subfloat[]{\label{subfig:1:b}\includegraphics[scale=0.2]{chapters/selim/png/channel_test_zoom.png}}
 \end{center}
...
\begin{figure}[tbp!]
  \begin{center}
    \subfloat[$Z_{_{F}}$]{\label{fig:a}\includegraphics[scale=0.15]{chapters/selim/png/channelZF.png}} \\
    \subfloat[$Z_{_{S}}$]{\label{fig:b}\includegraphics[scale=0.15]{chapters/selim/png/channelZS.png}}
 \end{center}
...
\label{selim:fig:dual_channel_1}
\end{figure}
\begin{figure}
  \begin{center}
...
\begin{figure}[tbp!]
\begin{center}
  \subfloat[]{\label{subfig:2:a}\includegraphics[scale=0.2]{chapters/selim/png/new_cavity.png}} \\
  \subfloat[]{\label{subfig:2:b}\includegraphics[scale=0.15]{chapters/selim/png/zoom_cavity.png}}
\end{center}
...
dependency is a working FEniCS installation. \emp{CBC.Solve} is
