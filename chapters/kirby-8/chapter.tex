...
\editornote{Need to update notation to use $\hat{T}$ for the reference
cell to match introductory chapter [kirby-7].}
...
\end{equation}
Let $F_T : T_0 \rightarrow T$ be an affine map from a
reference cell~$T_0$ to the current cell~$T$ as illustrated in
