...
other mentioned packages, we refer to~\cite{WilbersLangtangenEtAl2009a,www:weave}. Weave is part of
...
SFC (see Chapter~\ref{chap:alnes-3}), Swiginac~\cite{www:swiginac}, and Sympy~\cite{vCert'ik2009}.  In fact,
...
use Instant instead~\cite{WilbersLangtangenEtAl2009a}.
