...
%
\begin{figure}
  \subfloat[]{\includegraphics[height=0.35\textwidth]{chapters/nikbakht/png/mesh.png}
    \label{fig:nikbakht:poisson_contours_a}}
  \subfloat[]{\includegraphics[height=0.35\textwidth]{chapters/nikbakht/png/result.png}
