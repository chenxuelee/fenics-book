...
equations~\cite{BrezziFalk1991, Stenberg1984, TaylorHood1973}.
...
Laplacian~\cite{BoffiBrezziGastaldi2000}, may be less so.
...
in~Figure~\ref{rognes:fig:example}\subref{rognes:fig:rt}. This
...
problems~\cite{HernandezRomanVidal2005, HernandezRomanRomeroEtAl2009}. The type
...
is indeed proven so~\cite{RaviartThomas1977}. The Brezzi coercivity
...
(1 + 2 \pi^2)^{-1/2}$ cf.~\cite{ArnoldRognes2009}.)  The satisfactory
result observed in
...
triangles~\cite{TaylorHood1973, Stenberg1984, BrezziFalk1991}. The
