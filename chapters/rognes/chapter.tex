...
equations~\cite{BrezziFalk1991, TaylorHood1973}, others, such as the
reduced stability of the $\rognescg_1(\mathbb{V}) \times
...
\rognescodeintext{compute\_brezzi\_infsup}: The input consists of the
...
A collection of \rognescodeintext{InfSupConstant}s forms an
\rognescodeintext{InfSupCollection}. An \rognescodeintext{InfSupCollection}'s main
purpose is to identify whether or not the stability condition
associated with the inf-sup constants holds. The method
\rognescodeintext{is\_stable} returns a boolean answer. The stability
