...
ska~\citep{Babuvska1972/73} and Brezzi~\citep{Brezzi1974} in the early
...
equations was used in this context by Qin~\citep{Qin1994} and Chapelle
and Bathe~\citep{ChapelleBathe1993}. A fully automated approach has not
...
cf.~\citep{HernandezRomanRomeroEtAl2009}. \rognesascot{} applies a
...
(1 + 2 \pi^2)^{-1/2}$ cf.~\citep{ArnoldRognes2009}.)  The satisfactory
result observed in
