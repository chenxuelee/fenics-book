...
\begin{figure}
  \begin{center} \subfloat[Bad
    approximation]{ \label{rognes:fig:cg} \includegraphics[width=0.46\textwidth]{chapters/rognes/pdf/CG.pdf}
    } \subfloat[Good
    approximation]{ \label{rognes:fig:rt} \includegraphics[width=0.46\textwidth]{chapters/rognes/pdf/RT.pdf}
    }
    ...
    omitted.)}  \label{rognes:fig:example} \end{center}
\end{figure}
...
smallest non-zero eigenvalue will be the reduced Brezzi inf-sup
...
the inner products $(m, n)$, and a function space $W_h$ (and
