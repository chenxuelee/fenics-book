...
$\overline{\partial\Omega_{\mathrm{N}}
\cup \partial\Omega_{\mathrm{D}}} = \partial\Omega$. These details are
depicted in Figure~\ref{fig:narayanan:continuumpotato}.
...
equation.solve(u)
\end{python}
\caption{The relevant section of the class \emp{StaticMomentumBalanceSolver}, the solver for the static balance of
  linear momentum.}
...
is directed to the previously mentioned papers, and the \emp{MomentumBalanceSolver} class in the file \emp{solution\_algorithms.py}.
...
methods in the user-created class \emp{Twist} (see
