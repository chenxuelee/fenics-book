...
\fenicschapter{Lessons Learned in Mixed Language Programming Using Python, C++ and \swig}{Johan Hake and Kent-Andre Mardal}\label{mixedlanguage}
...
\codeinput{chapters/hake_mardal/code/setup.py}
...
\codeinput{chapters/hake_mardal/code/segfault_test.py}
...
\end{code}
\begin{figure}[htbp]
  \subfigure{ \includegraphics[width=8cm]{pics/fig1.png}} \\
  \subfigure{ \includegraphics[width=8cm]{pics/fig2.png}}
...
\end{figure}
\begin{figure}
  \subfigure{ \includegraphics[width=8cm]{pics/fig3.png}} \\
  \subfigure{ \includegraphics[width=8cm]{pics/fig4.png}}
...
\begin{figure}
  \subfigure{ \includegraphics[width=8cm]{pics/fig5.png}} \\
  \subfigure{ \includegraphics[width=8cm]{pics/fig6.png}}
