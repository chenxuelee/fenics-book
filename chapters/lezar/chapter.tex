...
\begin{figure}
 ...
 \resizebox{0.55\textwidth}{!}{\includegraphics{chapters/lezar/pdf/arbitrary_waveguide_cross_section.pdf}}
...
\begin{figure}[ht]
    ...
    \psfrag{a}{$a$}
    \psfrag{b}{$b$}
    \resizebox{0.4\textwidth}{!}{\includegraphics{chapters/lezar/pdf/hollow_rectangular_waveguide.pdf}}
...
\begin{figure}[ht]
\centering
 \subfigure[TE$_{10}$ mode.]{\resizebox{0.45\textwidth}{!}{\includegraphics{chapters/lezar/pdf/hollow_rectangular_calculated_TE_10.pdf}}}
 \subfigure[TE$_{01}$ mode.]{\resizebox{0.45\textwidth}{!}{\includegraphics{chapters/lezar/pdf/hollow_rectangular_calculated_TE_01.pdf}}}
...
\begin{figure}[ht]
\centering
 \subfigure[TM$_{11}$ mode.]{\resizebox{0.45\textwidth}{!}{\includegraphics{chapters/lezar/pdf/hollow_rectangular_calculated_TM_11.pdf}}}
 \subfigure[TM$_{21}$ mode.]{\resizebox{0.45\textwidth}{!}{\includegraphics{chapters/lezar/pdf/hollow_rectangular_calculated_TM_21.pdf}}}
...
\begin{figure}[h]
 \centering
 \resizebox{0.55\textwidth}{!}{\includegraphics{chapters/lezar/pdf/hollow_dispersion_curve.pdf}}
...
\begin{figure}
    ...
    \psfrag{b}{$b$}
    \psfrag{d}{$d$}
    \resizebox{0.45\textwidth}{!}{\includegraphics{chapters/lezar/pdf/half_loaded_rectangular_waveguide.pdf}}
...
\begin{figure}[h]
\centering
 \subfigure[First TE mode.]{\resizebox{0.45\textwidth}{!}{\includegraphics{chapters/lezar/pdf/half_filled_rectangular_calculated_TE_1.pdf}}}
 \subfigure[First TM  mode.]{\resizebox{0.45\textwidth}{!}{\includegraphics{chapters/lezar/pdf/half_filled_rectangular_calculated_TM_1.pdf}}}
...
\begin{figure}
 ...
 \psfrag{xaxis}{$x$}
 \resizebox{0.55\textwidth}{!}{\includegraphics{chapters/lezar/pdf/half_loaded_dispersion_curve.pdf}}
 \caption{\index{dispersion curves}Dispersion curves for the first 8 modes of a $1$~m~$\times~0.5$~m rectangular waveguide with its lower half filled with an $\epsilon_r = 4$ dielectric material.  Reference values for the first 4 modes from~\cite{Jin2002} are shown as $\blacksquare$.  The presence of complex mode pairs are indicated by $\blacktriangle$ and $\bullet$.}
...
\begin{figure}[t]
    ...
    \psfrag{t}{$t$}
    \psfrag{w}{$w$}
    \resizebox{0.5\textwidth}{!}{\includegraphics{chapters/lezar/pdf/shielded_microstrip_waveguide.pdf}}
...
\begin{figure}[h]
 \centering
 \resizebox{0.55\textwidth}{!}{\includegraphics{chapters/lezar/pdf/shielded_microstrip_dispersion_curve.pdf}}
...
\begin{figure}
 \centering
 \resizebox{0.5\textwidth}{!}{\includegraphics{chapters/lezar/pdf/hollow_h_plane_S_parameters.pdf}}
...
\begin{figure}[!h]
 ...
 {\resizebox{0.45\textwidth}{!}{\includegraphics{chapters/lezar/pdf/h_plane_iris.pdf}}}
...
\begin{figure}[h]
\centering
 \subfigure[Magnitude.]{\resizebox{0.48\textwidth}{!}{\includegraphics{chapters/lezar/pdf/h_plane_iris_S_parameters_magnitude.pdf}}}
 \subfigure[Phase.]{\resizebox{0.48\textwidth}{!}{\includegraphics{chapters/lezar/pdf/h_plane_iris_S_parameters_phase.pdf}}}
\caption{\index{S-parameters}Results for the magnitude and phase of the reflection coefficient (S$_{11}$ -- solid line) and transmission coefficient (S$_{21}$ -- dashed line) of an H-plane iris in a rectangular waveguide shown in Figure~\ref{lezar:fig:h_plane_iris}. Reference results from~\cite{PelCoc1998} are indicated by markers with $\blacksquare$ and $\bullet$ indicating the reflection and transmission coefficient respectively.}
