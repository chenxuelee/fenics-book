...
$\mu_r$, in this case) a JIT-compiled function is used.

\begin{lstlisting}[float=ht, caption=Material properties and functions., label=lezar:listing:material_properties]
